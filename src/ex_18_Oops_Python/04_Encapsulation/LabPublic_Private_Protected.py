class TestExample:
    ...
    def __init__(self):
        self.driver = "Chrome"  # public, Everyone can use it.
        self._config = "STAG"   # Protected, Within the folder allowed,not in any other folder
        self.__api__key = "ABC12345" # Private, Credentials.
